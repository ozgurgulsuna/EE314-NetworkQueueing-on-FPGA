...
% 0.0564284	0.0389851	0.0188192	0.00325963	0.01495	0.425266	0.75926	1
% 0.600157	0.545897	0.516856	0.489847 0.156547	0.439602	0.734815    1
Wl=[0.0757648	0.0625589	0.0384853	0.0115977]*1000	;          % Latency Weight Constant
Wr=[0	0.201112	0.573521	0.97039]*1000;          % Reliability Weight Constant
k = 0 ;                      % Drop penalty
% X = Wl.*t+Wr.*(f.^2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
