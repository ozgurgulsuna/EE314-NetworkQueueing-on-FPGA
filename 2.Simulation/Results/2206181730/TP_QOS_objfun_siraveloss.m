...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T_sample_size = 1000;      % Simulation Duration in Seconds
...
d_pi=(d./(read_count+d))*100;  % drop per input 
...
y(2) = (d_pi(1)<d_pi(2))*1000+(d_pi(2)==d_pi(1))*1000+(d_pi(1)>d_pi(2))/(d_pi(1)-d_pi(2)+0.1)+...
       10*((d_pi(1)<d_pi(3))*1000+(d_pi(3)==d_pi(1))*1000+(d_pi(1)>d_pi(3))/(d_pi(1)-d_pi(3)+0.1))+...
       100*((d_pi(1)<d_pi(4))*1000+(d_pi(4)==d_pi(1))*1000+(d_pi(1)>d_pi(4))/(d_pi(1)-d_pi(4)+0.1))+...
       (d_pi(2)<d_pi(3))*1000+(d_pi(3)==d_pi(2))*1000+(d_pi(2)>d_pi(3))/(d_pi(2)-d_pi(3)+0.1)+...
       10*((d_pi(2)<d_pi(4))*1000+(d_pi(4)==d_pi(2))*1000+(d_pi(2)>d_pi(4))/(d_pi(2)-d_pi(4)+0.1))+...
       (d_pi(3)<d_pi(4))*1000+(d_pi(4)==d_pi(3))*1000+(d_pi(3)>d_pi(4))/(d_pi(3)-d_pi(4)+0.1)+...
       (a(4)<a(3))*1000+(a(3)==a(4))*1000+(a(4)>a(3))/(a(4)-a(3)+0.1)+...
       10*((a(4)<a(2))*1000+(a(2)==a(4))*1000+(a(4)>a(2))/(a(4)-a(2)+0.1))+...
       100*((a(4)<a(1))*1000+(a(1)==a(4))*1000+(a(4)>a(1))/(a(4)-a(1)+0.1))+...
       (a(3)<a(2))*1000+(a(2)==a(3))*1000+(a(3)>a(2))/(a(3)-a(2)+0.1)+...
       10*((a(3)<a(1))*1000+(a(1)==a(3))*1000+(a(3)>a(1))/(a(3)-a(1)+0.1))+...
       (a(2)<a(1))*1000+(a(1)==a(2))*1000+(a(2)>a(1))/(a(2)-a(1)+0.1);
